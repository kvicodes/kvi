...
export default function Tech() {
  return (
    <BusinessPage
      ...
      metaDescription="KVI Tech builds software platforms, digital products and automation for real-world businesses. Products include ContractorOS and CampusGrid."
      headerTone="ink"
    >
      <Section tone="paper" divide id="products">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2">
          ...
          <Reveal delay={products.length * 90} className="sm:col-span-2">
